                 ...
                 try
{
       ...
       url= "jdbc:sqlserver://localhost\\SQLEXPRESS:1433;databaseName=test;integrateSecurity=false;encrypt=true;trustServerCertificate=true;"; // table details
        username = "sa"; // 
        password = "123";
        String query = "select *from custmast where loginname='"+ jTextField1.getText()  + "' and loginpwd='" + jPasswordField1.getText() + "'"; // query to be run
        ...
        {
             JOptionPane.showMessageDialog(this, "Invalid Customer Login", "Error", JOptionPane.ERROR_MESSAGE);
